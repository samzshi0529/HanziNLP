...
def dashboard():
    ...
    count_table = go.FigureWidget([count_trace], layout={'height': 300, 'width': 500})
    ...
    freq_table = go.FigureWidget([freq_trace], layout={'height': 300, 'width': 500})
    ...
    def update_table(button):
        ...
        top_tokens = token_freq.most_common(10)  # Get top 10 tokens
